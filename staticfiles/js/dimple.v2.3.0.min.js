  ...
  return b.axis = function (c, d, e, f, g, h) {
    ...
    this.svg = c, this.x = "10%", this.y = "10%", this.width = "80%", this.height = "80%", this.data = d, this.noFormats = !1, this.axes = [], this.series = [], this.legends = [], this.storyboard = null, this.titleShape = null, this.shapes = null, this.ease = a.easeCubicInOut, this.staggerDraw = !1, this.transition = {}, this._group = c.append("g"), this._group.attr("class", "dimple-chart"), this._gridlines_group = this._group.insert("g"), this._gridlines_group.attr("class", "dimple-gridlines-group"), this._axis_group = this._group.insert("g"), this._axis_group.attr("class", "dimple-axis-group"), this._tooltipGroup = null, this._assignedColors = {}, this._assignedClasses = {}, this._nextColor = 0, this._nextClass = 0, this._axisIndex = function (a, b) {
      ...
      var f,
          g = null,
          h = null;
      if (null !== c && void 0 !== c && (c = [].concat(c)), "string" == typeof a || a instanceof String) g = new b.axis(this, a, c, d, e), this.axes.push(g);else {
    ...
    null !== b && void 0 !== b && (b = [].concat(b)), this.chart = a, this.categoryFields = b, this.autoplay = !0, this.frameDuration = 3e3, this.storyLabel = null, this.onTick = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this._frame = 0, this._animationTimer = null, this._categories = [], this._cachedCategoryFields = [], this._orderRules = [], this._drawText = function () {
      ...
      b.storyLabel || (b.chart.axes.forEach(function (a) {
        "x" === a.position && (c += 1);
      }, b), b.storyLabel = b.chart._group.append("text").attr("class", "dimple-storyboard-label").attr("opacity", 1).attr("x", b.chart._xPixels() + .01 * b.chart._widthPixels()).attr("y", b.chart._yPixels() + (b.chart._heightPixels() / 35 > 10 ? b.chart._heightPixels() / 35 : 10) * (c > 1 ? 1.25 : -1)).call(function (c) {
    ...
    draw: function (c, d, e) {
      ...
      for (f = "step" === d.interpolation ? "step-after" : d.interpolation, p = b._getSeriesOrder(d.data || c.data, d), d.c && (d.x._hasCategories() && d.y._hasMeasure() || d.y._hasCategories() && d.x._hasMeasure()) && (I = !0), d.x._hasCategories() ? (B = "x", C = "y") : d.y._hasCategories() && (B = "y", C = "x"), g = 0; g < D.length; g += 1) {
        ...
        for (k = b._createClass(j), i = 0; i < E.length; i += 1) if (E[i].keyString === k) {
          l = i;
          break;
        }
      ...
      for (g = 0; g < E.length; g += 1) {
        if (q = E[g].points, v = E[g].group, r = [], L = [], I && b._addGradient(E[g].key, "fill-area-gradient-" + E[g].keyString, d.x._hasCategories() ? d.x : d.y, D, c, e, "fill"), K[v] && K[v].length > 0) for (h = 0, i = 0; h < K[v].length; h += 1) K[v][h] >= q[0][B] && K[v][h] <= q[q.length - 1][B] && (s = {}, s[B] = K[v][h], s[C] = J[v][K[v][h]], r.push(s), q[i][B] > K[v][h] ? L.push(s) : (L.push(q[i]), J[E[g].group][K[v][h]] = q[i][C], i += 1));else if (d._orderRules && d._orderRules.length > 0) L = q.concat(q[0]);else {
    ...
    draw: function (c, d, e) {
      ...
      for (f = "step" === d.interpolation ? "step-after" : d.interpolation, p = b._getSeriesOrder(d.data || c.data, d), d.c && (d.x._hasCategories() && d.y._hasMeasure() || d.y._hasCategories() && d.x._hasMeasure()) && (v = !0), g = 0; g < q.length; g += 1) {
        ...
        for (k = b._createClass(j), i = 0; i < r.length; i += 1) if (r[i].keyString === k) {
          l = i;
          break;
        }
    ...
    draw: function (c, d, e) {
      var f,
        ...
        var c,
            d = a.interpolate(this._current, b);
    ...
    var i,
        j,
        k,
        l = ["dimple-marker-back", g, c.keyString];
    ...
    return null !== d && void 0 !== d && (j = j.concat(d)), j = j.concat({
      ...
      if ("function" == typeof b.ordering) {
        if (a && a.length > 0) for (c in a[0]) a[0].hasOwnProperty(c) && i.indexOf(c) === -1 && i.push(c);
